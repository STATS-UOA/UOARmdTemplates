...
\pretitle{%
$if(branding)$%
\begin{textblock}{4}(2,0.8)\includegraphics[height=1.5cm]{uni-of-auckland}\end{textblock}%
\begin{textblock}{4}(16.5,0.8)\includegraphics[trim=53 0 0 0, clip=true,height=1.5cm]{uni-of-auckland}\end{textblock}%
\vspace*{-0.6cm}
$else$
\vspace*{-1cm}
$endif$
